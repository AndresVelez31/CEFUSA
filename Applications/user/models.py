...
class Player(models.Model):
    ...
    document_type = models.CharField(max_length=31, db_column="tipoDoc", choices=DocumentType.choices)
    
    identification = models.CharField(max_length=15, db_column="identificacion", validators=[MinLengthValidator(5)])
    ...
    training_session = models.CharField(max_length=15, db_column="jornadaEntreno", choices=TrainingSession.choices)
    ...
    kinship = models.CharField(max_length=30, db_column="parentesco") 
    
    health_center = models.CharField(max_length=45, db_column="centroAtencion") 
